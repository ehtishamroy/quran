...
@section('content')
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-bold text-gray-800">Create New Package</h2>
        </div>
        <div class="p-6">
            <form action="{{ route('admin.packages.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select name="color_theme"
                            ...
                            <option value="yellow" {{ old('color_theme') == 'yellow' ? 'selected' : '' }}>Yellow</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="currency" value="{{ old('currency', 'USD') }}" required maxlength="3"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#084D3C]">
                    ...
                    <div>
                        ...
                        <input type="number" name="days_per_week" value="{{ old('days_per_week') }}"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#084D3C]">
                    </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" rows="3"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#084D3C]">{{ old('description') }}</textarea>
                </div>

                <div class="mb-6">
                    <label class="block text-gray-700 font-medium mb-2">Features (One per line)</label>
                    <textarea name="features" rows="5"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#084D3C]">{{ old('features') }}</textarea>
                ...
                <div class="mb-6">
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="is_popular" value="1" {{ old('is_popular') ? 'checked' : '' }}
                            class="form-checkbox h-5 w-5 text-[#084D3C] rounded focus:ring-[#084D3C]">
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit" class="px-4 py-2 bg-[#084D3C] text-white rounded-lg hover:bg-green-800">Create
                        Package</button>
                </div>
            </form>
        </div>
