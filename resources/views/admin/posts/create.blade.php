            ...
            <div class="p-6">
                <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="lg:col-span-2 space-y-5">
                            ...
                            <div>
                                ...
                                <textarea name="content" rows="14" required
                                    class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#084D3C]">{{ old('content') }}</textarea>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="meta_description" rows="3" maxlength="500"
                                            placeholder="Brief summary for search engines (max 160 chars recommended)"
                                            class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#084D3C] text-sm">{{ old('meta_description') }}</textarea>
                                    </div>
                                    <div>
                    ...
                    <div class="flex justify-end space-x-4 mt-6 border-t pt-4">
                        ...
                        <button type="submit" class="px-6 py-2 bg-[#084D3C] text-white rounded-lg hover:bg-green-800">Create Post</button>
                    </div>
                </form>
            </div>
        </div>
